...
{
   // private readonly string emailFrom = "spready@yandex.ru";
    private readonly string emailTo;
    private readonly string smtpServer = "smtp.yandex.ru";
    // private readonly int smtpPort = 587;
    private readonly string smtpUsername = "vlazer03@yandex.ru";
    private readonly string smtpPassword = "buobrvhzcawkunza";
